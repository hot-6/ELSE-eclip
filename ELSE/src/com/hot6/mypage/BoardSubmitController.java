...
public class BoardSubmitController implements Execute{
   ...
   req.setAttribute("submits", mypageDAO.selectParsAll(userNum));
...
//   한 페이지에서 나오는 페이지 버튼의 개수
   ...
   result.setPath("/web/mypage/myPageApplication.jsp");
