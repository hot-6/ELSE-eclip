            ...
            <div class="List_list">
                <ul class="exchange_list">
                  <li>
                    <div class="list_card">
                      <a href="">
                        <header style="background-image: url(../img/promote1.jpg)" class="list-img">
                  ...
                  <li>
                    <div class="list_card">
                      <a href="">
                        <header style="background-image: url(../img/promote2.jpg)">
                  ...
                  <li>
                    <div class="list_card">
                      <a href="">
                        <header style="background-image: url(../img/promote3.jpg)">
